    ...
    public boolean isCellEditable(int row, int column) {
       return false;
        ...
        for(int i=0; i<model.getSolicitud().getLista_bienes().size(); i++) {
            ...
            datos[0] =  model.getSolicitud().getLista_bienes().get(i).getDescripcion();
            datos[1] =  model.getSolicitud().getLista_bienes().get(i).getMarca();
            datos[2] =  model.getSolicitud().getLista_bienes().get(i).getModelo();
            datos[3] = "" +  model.getSolicitud().getLista_bienes().get(i).getPrecio_unitario();
            modelo.addRow(datos);
            }
